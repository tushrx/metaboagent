...
a <plan> block listing 3-4 candidate approaches in JSON with keys
{id, title, route, host, summary, est_difficulty, est_confidence}. Do
NOT produce pathway steps, plasmid maps, primers, or confidence scores
in Phase 1. Close with "Pick an approach and I'll produce the full design."
